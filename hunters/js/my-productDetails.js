...
export class myBody extends HTMLElement {
    ...
    async add(e){
        ...
        if ($.nodeName == "BUTTON") {
            ...
            let div = document.createElement("my-product-details");
            div.insertAdjacentElement("beforeend", render.children[0]);
            document.querySelector("#products").insertAdjacentElement("beforeend", div);
            this.count++;
        }
    }
    connectedCallback() {
